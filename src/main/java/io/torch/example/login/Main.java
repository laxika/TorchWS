...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        torch.getRouteManager().defineRoute("/login", LoginPage.class, null, RequestMethod.GET);
        torch.getRouteManager().defineRoute("/login", LoginPage.class, null, RequestMethod.POST);
