...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        torch.getRouteManager().defineRoute("/login", LoginPage.class, RouteTarget.NO_DEPENDENCY, RequestMethod.GET);
        torch.getRouteManager().defineRoute("/login", LoginPage.class, RouteTarget.NO_DEPENDENCY, RequestMethod.POST);
